"""GTFS-RT servicealerts fetch + inlined protobuf decoder (no pip)."""
from __future__ import annotations

import time

from pipeline.common.http_retry import is_transient_http_error
from pipeline.config.constants import HTTP_HEADERS_PROTO
...
def http_bytes(url: str, *, timeout: int = 60, attempts: int = 5) -> tuple[bytes, int]:
    ...
    def _via_urllib():
        ...
        req = urllib.request.Request(url, headers=HTTP_HEADERS_PROTO, method="GET")
        try:
