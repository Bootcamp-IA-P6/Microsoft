...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    quickC1Bus: 'Buses en Sevilla',
    quickC1BusPrompt: '¿Qué buses llegan ahora a la parada 3698?',
    quickCibeles: 'Línea 5 en Sol',
    quickCibelesPrompt: '¿Cuánto tarda la línea 5 en llegar a la parada 5907?',
    quickLine27: 'Incidencias línea 46',
    quickLine27Prompt: '¿Hay alguna incidencia activa en la línea 46?',
    quickM1Freq: 'Frecuencia línea 51',
    quickM1FreqPrompt: '¿Cada cuánto pasa la línea 51?',
    ...
    themeLight: 'Claro',
    themeDark: 'Oscuro',
    themeHighContrast: 'Normal',
    themeNormal: 'Alto contraste',
  ...
  en: {
    ...
    quickC1Bus: 'Buses at Sevilla',
    quickC1BusPrompt: '¿Qué buses llegan ahora a la parada 3698?',
    quickCibeles: 'Line 5 at Sol',
    quickCibelesPrompt: '¿Cuánto tarda la línea 5 en llegar a la parada 5907?',
    quickLine27: 'Line 46 disruptions',
    quickLine27Prompt: '¿Hay alguna incidencia activa en la línea 46?',
    quickM1Freq: 'Line 51 frequency',
    quickM1FreqPrompt: '¿Cada cuánto pasa la línea 51?',
  ...
  pt: {
    ...
    quickC1Bus: 'Autocarros em Sevilla',
    quickC1BusPrompt: '¿Qué buses llegan ahora a la parada 3698?',
    quickCibeles: 'Linha 5 em Sol',
    quickCibelesPrompt: '¿Cuánto tarda la línea 5 en llegar a la parada 5907?',
    quickLine27: 'Incidências linha 46',
    quickLine27Prompt: '¿Hay alguna incidencia activa en la línea 46?',
    quickM1Freq: 'Frequência linha 51',
    quickM1FreqPrompt: '¿Cada cuánto pasa la línea 51?',
  ...
  ko: {
    ...
    quickC1Bus: '세비야 정류장 버스',
    quickC1BusPrompt: '¿Qué buses llegan ahora a la parada 3698?',
    quickCibeles: '솔 정류장 5번 노선',
    quickCibelesPrompt: '¿Cuánto tarda la línea 5 en llegar a la parada 5907?',
    quickLine27: '46번 노선 운행 정보',
    quickLine27Prompt: '¿Hay alguna incidencia activa en la línea 46?',
    quickM1Freq: '51번 노선 배차 간격',
    quickM1FreqPrompt: '¿Cada cuánto pasa la línea 51?',
